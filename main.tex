...
\begin{itemize}
    ...
    \large \item {Tensor Decompositions (CP, Tucker, Tensor-Train, and Tensor-Ring)}
...
\begin{itemize}
    ...
    \large \item \textcolor{red}{Tensor Decompositions (CP, Tucker, Tensor-Train, and Tensor-Ring)}
    \large \item{Transform-based Tensor Model and Applications}
    \large \item{Tensor Computations}
\end{itemize}
\end{frame}
...
\begin{frame}{Transform-based Tensor Model}
